...
@Component
@Scope("request")
class TransferTaxBetweenTenAndTwentyDays(val next: TransferTaxBetweenTwentyAndThirtyDays) :
    ...
    override fun attend(transfer: TransferDto): Boolean = getDaysDiff(transfer) in 11..20
