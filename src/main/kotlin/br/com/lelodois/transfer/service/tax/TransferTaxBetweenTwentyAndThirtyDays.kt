...
@Component
@Scope("request")
class TransferTaxBetweenTwentyAndThirtyDays(val next: TransferTaxBetweenThirtyAndFortyDays) :
    ...
    override fun attend(transfer: TransferDto): Boolean = getDaysDiff(transfer) in 21..30
