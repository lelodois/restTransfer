...
@Component
@Scope("request")
public class TransferTaxBetweenThirtyAndFortyDays (val next: TransferTaxAfterFortyDays) :
	...
	override fun attend(transfer: TransferDto): Boolean = getDaysDiff(transfer) >= 31 && getDaysDiff(transfer) <= 40
